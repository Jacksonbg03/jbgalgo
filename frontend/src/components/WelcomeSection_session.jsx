        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <h1 className="text-5xl font-extrabold bg-gradient-to-l from-[#FFC107] via-[#FF6F00] via-[#FF7F50] to-primary bg-clip-text text-transparent
">
          ...
          >
            <div className="flex items-center gap-3 text-white font-bold text-lg group">
